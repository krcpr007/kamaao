    ...
    <div className='container-fluid paddingRight mt-4'>   
      ...
      <div className='row'>
        <div className='col-lg-6 col-md-6 col-sm-12 col-12 detailsbutton'>
          <div className='row'>
            <div className='col-lg-4 col-md-6 col-sm-12 col-12 buttoncolor buttonRL active'><a>Add Product</a></div>
              ...
              <form onSubmit={submitproduct} encType="multipart/form-data" id="from_company">
                ...
                <div className='row'>
                  <div className='col-12 button-box'>
                    <button type="submit" className='backgroung-orange margin-top-17px'>Submit</button>
                  </div>
