                                ...
                                <div className='col-12'>
                                    <form id="#">
                                        ...
                                        <div className="row mb-3">
                                            ...
                                            <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 InputHeight InputBox">
                                                <input type="text" name="sub_title"
                                                    placeholder='Ex : Potential Monthly Earning'
                                                ...
                                                <div className='row d-flex justify-content-between'>
                                                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 width33 text-end InputHeight InputBox">
                                                        <select className="custom-select custom-selectMT" id="inputGroupSelect04"
                                                            value={companyInput.state}
                                                            onChange={handeInput} name='state'>
                                                            <option >State</option>
                                                            <option value="1">One</option>
                                                            <option value="2">Two</option>
                                                            <option value="3">Three</option>
                                                    ...
                                                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 width33 text-end InputHeight InputBox">
                                                        <select className="custom-select custom-selectMT" id="inputGroupSelect04"
                                                            value={companyInput.city}
                                                            onChange={handeInput} name='city'>
                                                            <option >City</option>
                                                            <option value="1">One</option>
                                                            <option value="2">Two</option>
                                                            <option value="3">Three</option>
                                                    ...
                                                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 width33 text-end InputHeight InputBox">
                                                        <select className="custom-select custom-selectMT" id="inputGroupSelect04"
                                                            value={companyInput.area}
                                                            onChange={handeInput} name='area'>
                                                            <option >Area</option>
                                                            <option value="1">One</option>
                                                            <option value="2">Two</option>
                                                            <option value="3">Three</option>
                                        ...
                                        <div className="row mb-3">
                                            ...
                                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 InputBox InputHeight">
                                        ...
                                        <div className="row mb-3">
                                            <div className='col-xl-4 col-lg-4 col-md-4 col-sm-12'>
                                                <label htmlFor="About Company" className="labelStyle">Tasks</label>
                                            </div>
                                            <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 InputBox">
                                                <textarea name="roles_responsibilities"
                                                    ...
                                                    className="form-control" id="#" rows="2" cols="2">
                                                </textarea>
                                            ...
                                            <div className='col-xl-8 col-lg-8 col-md-8 col-sm-12'>
                                                <div className='row d-flex justify-content-between'>
                                                    ...
                                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 width49per text-center InputHeight InputBox ">
                                                        ...
                                                        <select className="custom-select custom-selectMT" id="inputGroupSelect04"
                                                            name="experience_req"
                                                            value={companyInput.experience_req}
                                                            onChange={handeInput}>
                                                    ...
                                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 width49per InputHeight text-center ">
                                                        <MultiSelect
